...
public class MenuBarFactory {
    ...
    public void createMenuBar(){
        ...
        MenuItem newProjectMenuItem = new MenuItem("New Project", IconUtil.createIcon(IconUtil.projectImage));
        newProjectMenuItem.setOnAction(e -> newProjectAction.handle(e));
        MenuItem openProjectMenuItem = new MenuItem("Open Project", IconUtil.createIcon(IconUtil.openProjectImage));
        openProjectMenuItem.setOnAction(e -> openProjectAction.handle(e));
        MenuItem saveProjectMenuItem = new MenuItem("Save", IconUtil.createIcon(IconUtil.saveProjectImage));
        ...
        MenuItem createDataMapMenuItem = new MenuItem("Create DataMap", IconUtil.createIcon(IconUtil.dataMapImage));
        createDataMapMenuItem.setOnAction(e -> dataMapService.createDataMap());
        MenuItem createDbEntityMenuItem = new MenuItem("Create DbEntity", IconUtil.createIcon(IconUtil.dbEntityImage));
        createDbEntityMenuItem.setOnAction(e -> dbEntityService.createDbEntity());
        MenuItem createObjEntityMenuItem = new MenuItem("Create ObjEntity", IconUtil.createIcon(IconUtil.objEntityImage));
