...
public class DropColumnToModelIT extends MergeCase {
	...
	public void testRemoveFKColumnWithoutRelationshipInDb() throws Exception {
		...
		DbJoin rel1To2Join = new DbJoinBuilder()
		...
		map.addJoin(rel1To2Join);
		rel1To2Join.compile(map);

		DbRelationship rel1To2 = rel1To2Join.getRelationhsip();
		...
		map.getDbJoinList().remove(rel1To2Join);
