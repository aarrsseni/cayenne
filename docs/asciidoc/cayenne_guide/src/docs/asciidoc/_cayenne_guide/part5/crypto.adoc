...
NOTE: In addition to Java primitive types (and their object counterparts), _crypto module_ supports encryption only of _java.util.Date, java.math.BigInteger_ and _java.math.BigDecimal_ types.
