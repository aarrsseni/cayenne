...
- xref:http://velocity.apache.org[Apache Velocity Template Engine], version 1.6.x (and all its dependencies bundled with velocity-dep)

- xref:http://commons.apache.org/proper/commons-collections/[Apache Commons Collections], version 3.2.1

- xref:http://commons.apache.org/proper/commons-logging/[Apache Commons Logging], version 1.1
