...
public class QualifierObjectSelectTranslator extends QueryAssemblerHelper implements TraversalHandler {
        ...
        public QualifierObjectSelectTranslator(QueryAssembler queryAssembler) {
        ...
        protected Expression extractQualifier() {
            ...
            Expression qualifier = ((FluentSelect<?>) q).getWhere();
